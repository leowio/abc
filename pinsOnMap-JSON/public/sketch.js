...
socket.on("all-locations-from-server", function (serverLocations) {
  console.log("all locations from server", serverLocations);
  locations = serverLocations;
});

socket.on("location-from-server", function (newLocation) {
  console.log("location from server", newLocation);
...
function touchStarted() {
  if (mapInit) {
    if (
      ...
      socket.emit("location-from-client", newLocation);
